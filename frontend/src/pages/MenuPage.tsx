...
const MenuPage: React.FC = () => {
  ...
  // Real menu items data with images
  const menuItems: MenuItemType[] = useMemo(() => [
    // Beverages
    {
      id: 1,
      name: 'Masala Chai',
      description: 'Traditional Indian spiced tea with milk, cardamom, and aromatic spices',
      price: 25,
    ...
    },
    {
      id: 2,
      name: 'Fresh Juice',
      description: 'Freshly squeezed seasonal fruit juice - orange, pomegranate, or mixed fruit',
      price: 60,
    ...
    // Breakfast Items
    {
      id: 3,
      name: 'Poha',
      description: 'Flattened rice cooked with onions, mustard seeds, curry leaves, and garnished with coriander',
      price: 45,
      image: getFoodImage('Poha'),
      category: 'Breakfast',
      vendor: 'Maharashtrian Kitchen',
      rating: 4.5,
      prepTime: 8,
      isVegetarian: true,
      isAvailable: true,
    ...
    },
    {
      ...
      price: 55,
      image: getFoodImage('Idli Sambar'),
      category: 'Breakfast',
      vendor: 'South Indian Kitchen',
      rating: 4.7,
      prepTime: 12,
      isVegetarian: true,
      isAvailable: true,
      tags: ['Protein Rich', 'Traditional', 'Healthy'],
    },
    {
      id: 6,
      name: 'Medu Vada',
    ...
    },
    {
      ...
      isVegetarian: false,
      isAvailable: true,
      tags: ['Protein Rich', 'Quick', 'Filling'],
    },
    {
      id: 8,
      name: 'Bhurji Pav',
      description: 'Spiced scrambled eggs served with buttered bread rolls',
      price: 75,
      image: getFoodImage('Bhurji Pav'),
      category: 'Breakfast',
      ...
      isVegetarian: false,
      isAvailable: true,
      tags: ['Spicy', 'Street Food', 'Filling'],
    },
    ...
    },
    {
      ...
      price: 180,
      image: getFoodImage('Veg Thali'),
      category: 'Main Course',
      vendor: 'Traditional Kitchen',
      rating: 4.6,
      prepTime: 20,
      isVegetarian: true,
      isAvailable: true,
      tags: ['Complete Meal', 'Traditional', 'Healthy'],
    },
    {
      id: 11,
      name: 'Non-Veg Thali',
      description: 'Complete non-vegetarian meal with chicken curry, dal, roti, rice, and accompaniments',
      price: 250,
      image: getFoodImage('Non-Veg Thali'),
      category: 'Main Course',
      vendor: 'Traditional Kitchen',
      rating: 4.7,
      prepTime: 25,
      isVegetarian: false,
      isAvailable: true,
      tags: ['Complete Meal', 'Protein Rich', 'Traditional'],
      discount: 10
    },
    {
      id: 12,
    ...
    },
    {
      id: 13,
      name: 'Dal Khichadi',
      description: 'Comfort food made with rice and lentils, seasoned with spices',
      price: 90,
      image: getFoodImage('Dal Khichadi'),
      category: 'Main Course',
      vendor: 'Home Kitchen',
      rating: 4.3,
      prepTime: 15,
      isVegetarian: true,
      isAvailable: true,
      tags: ['Comfort Food', 'Healthy', 'Light'],
    },
    {
      id: 14,
      name: 'Sabudana Khichadi',
      description: 'Tapioca pearls cooked with peanuts, potatoes, and spices - perfect for fasting',
      price: 85,
      image: getFoodImage('Sabudana Khichadi'),
      category: 'Main Course',
      vendor: 'Fasting Special',
      rating: 4.2,
      prepTime: 12,
      isVegetarian: true,
      isAvailable: true,
      tags: ['Fasting Food', 'Light', 'Crunchy'],
    },
    ...
    // Snacks
    {
      ...
      description: 'Multi-layered sandwich with vegetables, cheese, and chutneys, grilled to perfection',
      price: 95,
      image: getFoodImage('Sandwich'),
      category: 'Snacks',
      vendor: 'Sandwich Corner',
      rating: 4.4,
      prepTime: 8,
      isVegetarian: true,
      isAvailable: true,
      tags: ['Quick', 'Cheesy', 'Crispy'],
    },

    // Popular Items (Additional variants)
    {
      id: 16,
